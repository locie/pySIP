...
Model Selection
---------------
Cb not statically significant

(north_T)
  - Np: 15
  - fit: close to bounds
  - log-lik fit: -4019.949255
  - log-lik pred: -2847.930611

(cellar_AT)
  - Np: 15
  - fit: close to bounds
  - log-lik fit: -3962.432407
  - log-lik pred: -2826.78271982

(attic_T)
  - Np: 15
  - fit: close to bounds
  - log-lik fit: -4007.334911
  - log-lik pred: -2846.34166521

"""
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
from bopt.statespace.rc import TwTiTb_RoRiRbAwAicv
...
reg.ss.parameters.set_parameter(
    "Ro", value=1.0, transform="lower", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Ri", value=5e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Rb", value=5e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Cw", value=5e-2, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
    "Ci", value=5e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Cb", value=5e-2, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
    "Aw", value=1.0, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
    "Ai", value=1.0, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
    "cv", value=1.0, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
    "sigw_w", value=0.1, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "sigw_i", value=0.1, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "sigw_b", value=0.1, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "sigv", value=0.1, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "x0_w", value=0.28, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter("x0_i", value=y0, transform="fixed")
reg.ss.parameters.set_parameter(
    "x0_b", value=0.28, transform="lowup", bounds=(1e-8, 1.0))
...
reg.ss.parameters.set_parameter("sigx0_b", value=1.0, transform="fixed")
