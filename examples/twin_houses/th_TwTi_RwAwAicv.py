...
---------------
  ...
  - Np: 10
  - fit: ok
  - log-lik fit: -3755.176930
  - log-lik pred: -2693.713827
"""

import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
from bopt.statespace.rc import TwTi_RwAwAicv
...
reg = Regressor(TwTi_RwAwAicv())

reg.ss.parameters.set_parameter("Rw", value=1e-3, transform="log")
