...
Model Selection
---------------
global remarks: Rw seems better suited than Ro and Ri
for the three cases

TwTi_RoRiRbAwAi (north_T):
  - Np: x
  - fit: x
  - log-lik fit: x
  - log-lik pred: x
  - remarks: Rw not identifiable

TwTi_RoRiRbAwAi (cellar_AT):
  - Np: x
  - fit: x
  - log-lik fit: x
  - log-lik pred: x

TwTi_RoRiRbAwAi (attic_T):
  - Np: 10
  - fit: ok
  - log-lik fit: -3934.454532
  - log-lik pred: -2777.380944
  - pvalue Ro = 5.19e-2
...
from bopt.statespace.rc import TwTi_RoRiRbAwAi
