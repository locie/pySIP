...
from bopt.statespace.rc import TwTiTb_RoRiRibRbbAwAicv
...
reg = Regressor(TwTiTb_RoRiRibRbbAwAicv())
...
reg.ss.parameters.set_parameter(
    "Rib", value=1e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Rbb", value=1e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
