...
---------------
  ...
  - Np: 15
  - fit: ok
  - log-lik fit: -4003.680727
  - log-lik pred:-2834.5601865
"""

import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
from bopt.statespace.rc import TwTiTm_RoRiRmAwAicv
...
reg.ss.parameters.set_parameter("x0_m", value=0.28, transform="log")
