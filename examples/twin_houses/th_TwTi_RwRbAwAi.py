...
TwTi_RwRbAwAi (cellar_AT):
  - Np: x
  - fit: x
  - log-lik fit: x
  - log-lik pred: x

TwTi_RwRbAwAi (attic_T):
  - Np:
  - fit:
  - log-lik fit:
  - log-lik pred:
...
from bopt.statespace.rc import TwTi_RwRbAwAi
...
reg.ss.parameters.set_parameter("Rb", value=1e-3,
                                transform="lowup",
                                bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter("Cw", value=1e-2,
                                transform="lowup",
                                bounds=(1e-8, 1.0))
