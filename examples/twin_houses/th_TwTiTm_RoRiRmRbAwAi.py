...
---------------
  ...
  - Np: 15
  - fit: ok
  - log-lik fit: -4011.179764
  - log-lik pred: -2817.67515092
"""

import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
from bopt.statespace.rc import TwTiTm_RoRiRmRbAwAi
...
reg = Regressor(TwTiTm_RoRiRmRbAwAi())

reg.ss.parameters.set_parameter(
    "Ro", value=5.53e-2, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
