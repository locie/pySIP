...
from bopt.statespace.rc import TwTiTb_RwRbAwAicv
...
reg = Regressor(TwTiTb_RwRbAwAicv())

reg.ss.parameters.set_parameter(
    "Rw", value=5e-3, transform="lower", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Rb", value=5e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Cw", value=5e-1, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
    "Ci", value=5e-3, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "Cb", value=5e-3, transform="lowup", bounds=(1e-8, 10.0))
reg.ss.parameters.set_parameter(
...
reg.ss.parameters.set_parameter(
    "sigw_w", value=0.01, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "sigw_i", value=0.01, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "sigw_b", value=0.01, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
    "sigv", value=0.01, transform="lowup", bounds=(1e-8, 1.0))
reg.ss.parameters.set_parameter(
