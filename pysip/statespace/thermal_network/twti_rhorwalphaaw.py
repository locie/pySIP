...
@dataclass
class TwTi_rhoRwalphaAw(RCModel):
    ...
    params = [
        ...
        ('SOLAR_APERTURE', 'Aw', 'effective total wall surface'),
    ...
    def update_continuous_ssm(self):
        ...
        self.B[:] = [
            [1.0 / (Cw * Rw * rho), (Aw * alpha) / Cw, 0.0],
            [0.0, (1.0 - alpha) * Aw / Ci, 1.0 / Ci],
        ]
    ...
    def update_continuous_dssm(self):
        Rw, rho, Cw, Ci, Aw, alpha, *_ = self.parameters.theta
        ...
        self.dB['Ci'][1, 1:] = [Aw * (alpha - 1) / Ci ** 2, -1.0 / Ci ** 2]
        self.dB['Aw'][:, 1] = [alpha / Cw, (1.0 - alpha) / Ci]
        self.dB['alpha'][:, 1] = [Aw / Cw, -Aw / Ci]
