...
@dataclass
class TwTiTh_RoRiRhAwAiclcv(RCModel):
    """3rd order RC model"""
    ...
    params = [
        ...
        ('COEFFICIENT', 'cl', 'internal load contribution scaling'),
    ...
    def update_continuous_dssm(self):
        Ro, Ri, Rh, Cw, Ci, Ch, Aw, Ai, cl, cv, *_ = self.parameters.theta
