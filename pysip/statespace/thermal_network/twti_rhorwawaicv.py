...
@dataclass
class TwTi_rhoRwAwAicv(RCModel):
    ...
    params = [
        ...
        ('COEFFICIENT', 'cv', 'scaling of the ventilation'),
    ...
    def update_continuous_ssm(self):
        ...
        self.B[:] = [[1.0 / (Cw * Rw * rho), Aw / Cw, 0.0, 0.0], [0.0, Ai / Ci, 1.0 / Ci, cv / Ci]]
    ...
    def update_continuous_dssm(self):
        Rw, rho, Cw, Ci, Aw, Ai, cv, *_ = self.parameters.theta
