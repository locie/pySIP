...
@dataclass
class TwTiTm_RoRiRbAwAicv(RCModel):
    ...
    params = [
        ...
        ('THERMAL_RESISTANCE', 'Rb', 'between the indoor and the adjacent space'),
    ...
    def update_continuous_ssm(self):
        ...
        self.A[:] = [
            ...
            [1.0 / (Ci * Ri), -(2.0 * Rb + Ri) / (Ci * Rb * Ri), 1.0 / (Ci * Ri)],
    ...
    def update_continuous_dssm(self):
        Ro, Ri, Rb, Cw, Ci, Cm, Aw, Ai, cv, *_ = self.parameters.theta
        ...
        self.dB['Cw'][0, :3] = [-1.0 / (Cw ** 2 * Ro), 0.0, -Aw / Cw ** 2]
