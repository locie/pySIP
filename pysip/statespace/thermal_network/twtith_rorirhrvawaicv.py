...
@dataclass
class TwTiTh_RoRiRhRvAwAicv(RCModel):
    """3rd order RC model"""
    ...
    params = [
        ...
        ('THERMAL_RESISTANCE', 'Rv', 'between the outdoor and the indoor'),
    ...
    def update_continuous_dssm(self):
        Ro, Ri, Rh, Rv, Cw, Ci, Ch, Aw, Ai, cv, *_ = self.parameters.theta
