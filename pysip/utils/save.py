...
def save_model(path, model):
    ...
    try:
        ...
        warnings.warn("Deleting continuous dssm while serializing model hasn't been successfull.")
...
def load_model(path):
    ...
    try:
        ...
        warnings.warn("Updating continuous dssm while deserializing model hasn't been successfull.")
    return model
