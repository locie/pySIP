...
class TwTi_RwAwAi(RCModel):
    ...
    def update_state_space_model(self):
        (Rw, Cw, Ci, Aw, Ai, sigw_w, sigw_i, sigv, x0_w, x0_i, sigx0_w, sigx0_i, *_) = self.parameters.theta
        ...
        self.B[:] = [
            [2.0 / (self.sC * Cw * Rw), Aw / (self.sC * Cw), 0.0],
    ...
    def update_jacobian(self):
        (Rw, Cw, Ci, Aw, Ai, *_) = self.parameters.theta
