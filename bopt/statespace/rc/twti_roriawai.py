...
class TwTi_RoRiAwAi(RCModel):
    ...
    def update_state_space_model(self):
        (Ro, Ri, Cw, Ci, Aw, Ai, sigw_w, sigw_i, sigv, x0_w, x0_i, sigx0_w, sigx0_i, *_) = self.parameters.theta
        ...
        self.B[1, 1:] = [Ai / (Ci * self.sC), 1. / (Ci * self.sC)]
    ...
    def update_jacobian(self):
        (Ro, Ri, Cw, Ci, Aw, Ai, *_) = self.parameters.theta
        ...
        self.dB['Ci'][1, 1:] = [-Ai / (Ci**2 * self.sC), -1. / (Ci**2 * self.sC)]
