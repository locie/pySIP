...
from bopt.core import Parameters
...
def test_repr(parameters, parameters_beta, parameters_with_transforms):
    ...
    assert parameters.__repr__() == """Parameters alpha
Parameter(a, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
Parameter(b, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
Parameter(c, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
"""

    s = parameters + parameters_beta + parameters_with_transforms
    assert s.__repr__() == """Parameters alpha__beta__transform
* alpha__beta
    * alpha
        Parameter(a, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
        Parameter(b, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
    ...
    * beta
        Parameter(c, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
        Parameter(d, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
        Parameter(e, value=0.000e+00, transform=none, bounds=(None, None), prior=None)
* transform
    Parameter(a, value=1.000e+00, transform=log, bounds=(None, None), prior=None)
    Parameter(b, value=2.000e+00, transform=lowup, bounds=(1.0, 3.0), prior=None)
"""
